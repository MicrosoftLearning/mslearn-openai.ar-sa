...
لتوزيع هذه النماذج، ستستخدم استوديو الذكاء الاصطناعي.

1. في بوابة Azure، انتقل إلى موارد Azure OpenAI. ثم استخدم الرابط لفتح المورد الخاص بك في **استوديو الذكاء الاصطناعي في Azure**.
1. في استوديو الذكاء الاصطناعي في Azure، في صفحة **عمليات التوزيع**، اعرض عمليات توزيع النموذج الحالية. ثم قم بإنشاء نشر نموذج أساسي جديد لنموذج **text-embedding-ada-002** بالإعدادات التالية:
...
لتسهيل استخدام بياناتك الخاصة في مطالبة، ستقوم بفهرستها باستخدام البحث بالذكاء الاصطناعي في Azure. ستستخدم النص الذي يتضمن النموذج الذي قمت بتوزيعه سابقًا أثناء عملية الفهرسة *لتحويل* البيانات النصية (يؤدي هذا إلى تمثيل كل رمز نصي في الفهرس بمتجهات رقمية - مما يجعله متوافقًا مع الطريقة التي يمثل بها نموذج الذكاء الاصطناعي التوليدي النص)
...
1. في الصفحة التالية، <u>لا</u> تحدد الخيار الأول لتحويل الصور إلى رموز أو استخراج البيانات باستخدام مهارات الذكاء الاصطناعي.
