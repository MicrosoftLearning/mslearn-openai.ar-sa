...
2. في Azure OpenAI Studio، في صفحة **عمليات التوزيع**، اعرض عمليات توزيع النموذج الحالية. إذا لم يكن لديك واحدة بالفعل، فعليك إنشاء توزيع جديد لنموذج **gpt-35-turbo-16k** بالإعدادات التالية:
    ...
    - **اسم التوزيع**: *اسم فريد من اختيارك. وستستخدم هذا الاسم لاحقًا في المعمل.*
    - **خيارات متقدمة**
...
3. في منطقة **الإعداد**، قم بتعيين رسالة النظام إلى `You are a programming assistant helping write code` وتطبيق التغييرات.
...
5. بعد ذلك، أرسل المطالبة `Do the same thing, but this time write it in C#`.
...
6. بعد ذلك، دعونا نستكشف استخدام الذكاء الاصطناعي لفهم التعليمة البرمجية. أرسل المطالبة التالية كرسالة المستخدم.
...
تم توفير تطبيقات لكل من C# وPython، وكذلك نموذج ملف نصي ستستخدمه لاختبار التلخيص. يتميز كلا التطبيقين بالوظيفة نفسها. أولاً، ستكمل بعض الأجزاء الرئيسية من التطبيق لتمكين استخدام مورد Azure OpenAI الخاص بك.
