...
يوفر Azure بوابة مستندة إلى الويب تسمى **استوديو الذكاء الاصطناعي في Azure**، يمكنك استخدامها لتوزيع النماذج وإدارتها واكتشافها. ستبدأ استكشافك لـ Azure OpenAI باستخدام استوديو الذكاء الاصطناعي في Azure لتوزيع نموذج.

> **ملاحظة**: خلال استخدام استوديو الذكاء الاصطناعي في Azure، قد تعرض مربعات الرسائل التي تقترح مهامًا عليك تنفيذها. يمكنك إغلاق هذه الخطوات واتباع الخطوات الواردة في هذا التمرين.
