...
يوفر Azure مدخلًا مستندًا إلى الويب يسمى **استوديو الذكاء الاصطناعي في Azure**، يمكنك استخدامه لتوزيع النماذج وإدارتها واكتشافها. ستبدأ اكتشافك لـ Azure OpenAI باستخدام استوديو الذكاء الاصطناعي في Azure لتوزيع نموذج.

> **ملاحظة**: خلال استخدام استوديو الذكاء الاصطناعي في Azure، قد تُعرض مربعات الرسائل التي تقترح مهامًا عليك تنفيذها. يمكنك إغلاق هذه الخطوات واتباع الخطوات الواردة في هذا التمرين.

1. في بواية Azure، في صفحة **نظرة عامة** لمورد Azure OpenAI، مرر لأسفل إلى قسم **الشروع في العمل** وحدد الزر للانتقال إلى **استوديو الذكاء الاصطناعي**.
1. في استوديو الذكاء الاصطناعي في Azure، في الجزء الموجود على اليمين، حدد جزء **عمليات التوزيع** واعرض عمليات توزيع النموذج الموجودة. إذا لم يكن لديك واحدة بالفعل، فعليك إنشاء توزيع جديد لنموذج **gpt-35-turbo-16k** بالإعدادات التالية:
...
4. تحديث قيم التكوين لتشمل:
    ...
    - **اسم التوزيع** الذي حددته لتوزيع النموذج الخاص بك (متوفر في صفحة **عمليات التوزيع** في استوديو الذكاء الاصطناعي في Azure).
5. احفظ ملف التكوين.
